...
data class MovieDetailsResponseDto(
    ...
    var movieDetailsBelongsToCollectionDto: MovieDetailsBelongsToCollectionDto? =
        MovieDetailsBelongsToCollectionDto(),
    @SerializedName("budget") var budget: Int? = null,
    @SerializedName("genres") var genres: ArrayList<MovieDetailsGenresDto> = arrayListOf(),
