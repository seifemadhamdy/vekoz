                  ...
                  Row(
                      ...
                      verticalAlignment = Alignment.CenterVertically) {
                        AsyncImage(
                            ...
                            modifier = Modifier.fillMaxWidth(fraction = goldenRatioComplementary),
                  ...
                  AnimatedVisibility(
                      ...
                      exit = fadeOut() + scaleOut()) {
                        ...
                        OutlinedTextField(
                            ...
                            placeholder = {
                              Text(
                                  text = stringResource(R.string.find_a_movie_that_s_oscar_worthy),
            ...
            LazyColumn(
                ...
                contentPadding =
                    PaddingValues(
                        ...
                        top = paddingValues.calculateTopPadding() + lazyColumnPadding,
                            ...
                            paddingValues.calculateEndPadding(layoutDirection) + lazyColumnPadding,
                ...
                verticalArrangement = Arrangement.spacedBy(lazyColumnPadding)) {
                  ...
                  groupedMoviesByReleaseYear.forEach { (releaseYear, movies) ->
                    ...
                    items(items = movies, key = { it.id ?: "item_at_${movieData.indexOf(it)}" }) {
                        movie ->
                      MovieCard(
                          movieItemData = movie,
